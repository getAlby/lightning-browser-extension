...
const getMnemonic = (message) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (id && Object.keys(accounts).includes(id)) {
        ...
        if (!account.mnemonic)
            return { data: null };
        const mnemonic = (0, crypto_1.decryptData)(account.mnemonic, password);
        return {
            data: mnemonic,
        };
    }
