...
const encryptOrPrompt = (message, sender) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    function encrypt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield nostr.nip04Encrypt(message.args.peer, message.args.plaintext);
            return { data: response };
        });
    }
});
exports.default = encryptOrPrompt;
