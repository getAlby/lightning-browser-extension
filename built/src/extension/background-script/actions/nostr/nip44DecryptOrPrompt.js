...
const nip44DecryptOrPrompt = (message, sender) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    function nip44Decrypt() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield nostr.nip44Decrypt(message.args.peer, message.args.ciphertext);
            return { data: response };
        });
    }
});
exports.default = nip44DecryptOrPrompt;
