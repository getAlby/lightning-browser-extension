...
const metaDataRules = {
    ...
    image: {
        ...
        processor: (imageUrl, context) => context.options.forceImageHttps === true
    ...
    icon: {
        ...
        processor: (iconUrl, context) => context.options.forceImageHttps === true
