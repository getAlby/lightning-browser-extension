    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        webextension_polyfill_1.default.runtime.onMessage.addListener((request, sender, sendResponse) => {
            ...
            if (request.action === "accountChanged" && isEnabled) {
                window.postMessage({ action: "accountChanged", scope: "webbtc" }, window.location.origin);
            }
        });
        ...
        window.addEventListener("message", (ev) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (ev.data && !ev.data.response) {
                ...
                if (isRejected) {
                    console.error("Enable had failed. Rejecting further WebBTC calls until the next reload");
                    return;
                }
