...
describe("ConfirmAddAccount", () => {
    test("render", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(yield react_1.screen.findByText("This website wants to add a wallet (Citadel (over Tor)):")).toBeInTheDocument();
        expect(yield react_1.screen.findByText("Your Citadel wallet")).toBeInTheDocument();
    }));
});
