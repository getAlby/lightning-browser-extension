...
function ConfirmSignSchnorr() {
    ...
    const sigHash = (_a = navState.args) === null || _a === void 0 ? void 0 : _a.sigHash;
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "h-full flex flex-col overflow-y-auto no-scrollbar", children: [(0, jsx_runtime_1.jsx)(ScreenHeader_1.default, { title: t("title") }), !successMessage ? ((0, jsx_runtime_1.jsx)("form", { onSubmit: handleSubmit, className: "h-full", children: (0, jsx_runtime_1.jsxs)(Container_1.default, { justifyBetween: true, maxWidth: "sm", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(PublisherCard_1.default, { title: origin.name, image: origin.icon, url: origin.host }), (0, jsx_runtime_1.jsx)(ContentMessage_1.default, { heading: t("allow", {
                                    ...
                                    }), content: sigHash })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col gap-4", children: [(0, jsx_runtime_1.jsx)(PermissionModal_1.default, { isOpen: modalOpen, onClose: () => {
                                        setModalOpen(false);
                                    }, permissionCallback: (permission) => {
                                        setPermissionOption(permission);
                                        setModalOpen(false);
                                    }, permission: tPermissions("nostr.signschnorr.title") }), (0, jsx_runtime_1.jsx)(ConfirmOrCancel_1.default, { disabled: loading, loading: loading, onCancel: reject, cancelLabel: tCommon("actions.deny"), destructive: true }), (0, jsx_runtime_1.jsx)(PermissionSelector_1.default, { i18nKey: permissionOption, values: {
...
exports.default = ConfirmSignSchnorr;
