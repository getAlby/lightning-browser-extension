...
const LiquidEnable_1 = __importDefault(require("~/app/components/Enable/LiquidEnable"));
...
function LiquidEnable(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: hasMnemonic ? ((0, jsx_runtime_1.jsx)(LiquidEnable_1.default, { origin: props.origin })) : ((0, jsx_runtime_1.jsx)(onboard_1.default, {})) }));
}
exports.default = LiquidEnable;
