...
describe("ConfirmGetAddress", () => {
    test("render", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(yield react_1.screen.findByText("Allow this website to:")).toBeInTheDocument();
        expect(yield react_1.screen.findByText("Read your Bitcoin receive address")).toBeInTheDocument();
    }));
});
