...
describe("ConfirmSignMessage", () => {
    test("render", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(yield react_1.screen.findByText("This website asks you to sign:")).toBeInTheDocument();
        expect(yield react_1.screen.findByText("Test message")).toBeInTheDocument();
    }));
});
