...
function LiquidConfirmGetAddress() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "h-full flex flex-col overflow-y-auto no-scrollbar", children: [(0, jsx_runtime_1.jsx)(ScreenHeader_1.default, { title: t("title") }), (0, jsx_runtime_1.jsxs)(Container_1.default, { justifyBetween: true, maxWidth: "sm", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(PublisherCard_1.default, { title: origin.name, image: origin.icon, url: origin.host, isSmall: false }), (0, jsx_runtime_1.jsxs)("div", { className: "dark:text-white pt-6 mb-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "mb-2", children: t("allow") }), (0, jsx_runtime_1.jsxs)("div", { className: "mb-2 flex items-center", children: [(0, jsx_runtime_1.jsx)(react_1.PopiconsCheckLine, { className: "w-5 h-5 mr-2" }), (0, jsx_runtime_1.jsx)("p", { className: "dark:text-white", children: tPermissions("liquid.getaddress.description") })] })] })] }), (0, jsx_runtime_1.jsx)("form", { onSubmit: handleSubmit, children: (0, jsx_runtime_1.jsxs)("div", { className: "text-center flex flex-col", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center mb-4", children: [(0, jsx_runtime_1.jsx)(Checkbox_1.default, { id: "remember_permission", name: "remember_permission", checked: rememberPermission, onChange: (event) => {
                                                setRememberPermission(event.target.checked);
                                            } }), (0, jsx_runtime_1.jsx)("label", { htmlFor: "remember_permission", className: "cursor-pointer ml-2 block text-sm text-gray-900 font-medium dark:text-white", children: tCommon("actions.remember") })] }), (0, jsx_runtime_1.jsx)(ConfirmOrCancel_1.default, { disabled: loading, loading: loading, label: tCommon("actions.confirm"), onCancel: reject }), (0, jsx_runtime_1.jsx)("a", { className: "mt-4 underline text-sm text-gray-400 mx-4 overflow-hidden text-ellipsis whitespace-nowrap", href: "#", onClick: block, children: t("block_and_ignore", { host: origin.host }) })] }) })] })] }));
}
exports.default = LiquidConfirmGetAddress;
