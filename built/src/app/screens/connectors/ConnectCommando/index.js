...
function ConnectCommando() {
    ...
    return ((0, jsx_runtime_1.jsx)(ConnectorForm_1.default, { title: (0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-bold dark:text-white", children: (0, jsx_runtime_1.jsx)(react_i18next_1.Trans, { i18nKey: "title", t: t }) }), description: (0, jsx_runtime_1.jsx)(react_i18next_1.Trans, { i18nKey: "page.instructions", t: t, components: [
                ...
                (0, jsx_runtime_1.jsx)("a", { target: "_blank", rel: "noreferrer", className: "underline", href: "https://github.com/daywalker90/cln-nip47#installation" }),
            ] }), logo: core_ln_svg_1.default, submitLoading: loading, submitDisabled: formData.nostrWalletConnectUrl === "", onSubmit: handleSubmit, children: (0, jsx_runtime_1.jsx)("div", { className: "mt-4 mb-6", children: (0, jsx_runtime_1.jsx)(TextField_1.default, { id: "nostrWalletConnectUrl", label: t("page.url.label"), placeholder: t("page.url.placeholder"), required: true, onChange: handleChange, autoFocus: true }) }) }));
}
exports.default = ConnectCommando;
