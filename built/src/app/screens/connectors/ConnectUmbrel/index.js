...
function ConnectUmbrel() {
    ...
    return ((0, jsx_runtime_1.jsxs)(ConnectorForm_1.default, { title: (0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-bold dark:text-white", children: (0, jsx_runtime_1.jsx)(react_i18next_1.Trans, { i18nKey: "page.title", t: t, components: [
                    ...
                    (0, jsx_runtime_1.jsx)("a", { className: "underline", href: "https://umbrel.com/" }),
                ] }) }), description: (0, jsx_runtime_1.jsx)(react_i18next_1.Trans, { i18nKey: "page.instructions", t: t, 
            // eslint-disable-next-line react/jsx-key
            components: [(0, jsx_runtime_1.jsx)("strong", {}), (0, jsx_runtime_1.jsx)("br", {})] }), logo: umbrel_png_1.default, submitLoading: loading, submitDisabled: formData.url === "" || formData.macaroon === "", onSubmit: handleSubmit, image: "https://cdn.getalby-assets.com/connector-guides/umbrel.png", children: [(0, jsx_runtime_1.jsx)("div", { className: "mt-6", children: (0, jsx_runtime_1.jsx)(TextField_1.default, { id: "lndconnect", type: lndconnectUrlVisible ? "text" : "password", autoComplete: "new-password", label: t("rest_url.label"), placeholder: t("rest_url.placeholder"), onChange: handleLndconnectUrl, required: true, autoFocus: true, endAdornment: (0, jsx_runtime_1.jsx)(PasswordViewAdornment_1.default, { onChange: (passwordView) => {
