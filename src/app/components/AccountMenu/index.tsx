...
function AccountMenu({ showOptions = true }: Props) {
  ...
  // - add a minimum width to match the dropdown menu
  const accountMenuWidthClassnameMobile = "calc(100%-theme(space.2)-24px)";
  const accountMenuWidthClassname = `min-w-[theme(space.56)] max-w-[${accountMenuWidthClassnameMobile}] md:max-w-[280px] lg:max-w-[400px] xl:max-w-[500px]`;
  return (
    <div
