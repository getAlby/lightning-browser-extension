                  ...
                  <div className="relative flex flex-grid">
                    <div className="w-32 h-32 md:w-48 md:h-48">
                      ...
                      {!auth.accountLoading && auth.account ? (
                        <Avatar
                          size={40}
                          className="border-4 border-white rounded-full absolute inset-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-white"
                        ...
                        auth.accountLoading && (
                          <SkeletonLoader
                            circle
                            opaque={false}
                            className="w-[40px] h-[40px] border-4 border-white rounded-full absolute inset-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-100"
                          />
                        )
                      )}
                    </div>
