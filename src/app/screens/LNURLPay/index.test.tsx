...
describe("LNURLPay", () => {
  ...
  test("renders via Send (popup)", async () => {
    ...
    expect(await screen.getByText("tAQIk")).toBeInTheDocument();
    expect(await screen.getByText("nCBZFVK Gg")).toBeInTheDocument();
