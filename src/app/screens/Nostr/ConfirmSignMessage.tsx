          ...
          <Container justifyBetween maxWidth="sm">
            ...
            <div>
              <div className="flex items-center mb-4">
                ...
                {/* <Hyperlink>Manage permissions</Hyperlink> */}
                ...
                >
                  <option selected>Ask me every time</option>
                  <option value="US">
                    Remember for short messages on snort.social
                  </option>
                  <option value="CA">
                    Remember for all events on snort.social
                  </option>
                </select>
              </div>
              <ConfirmOrCancel
