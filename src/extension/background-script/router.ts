...
export type ExtendedRouteArgs = RouteArgs & NostrRouteArgs;

type RouteResponseReturnDataType<T> = T extends { data: infer U }
  ? U
  : undefined;
...
export type ExtendedRouteResponse = RouteResponse & NostrRouteResponse;
